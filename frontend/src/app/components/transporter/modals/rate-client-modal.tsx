...
import { submitRating } from '../../../lib/shipment-api';
    ...
    <div className="flex flex-col items-center gap-4 py-6 animate-fade-in">
      ...
      <div className="text-center">
        ...
        <p className="text-sm text-gray-400">
          Tu opinión ayuda a mejorar la comunidad de clientes.
        </p>
      </div>
      <button
        onClick={onClose}
        className="mt-2 px-6 py-2.5 bg-[#3B82F6] text-white rounded-[10px] font-bold text-sm hover:bg-[#2563EB] transition-all shadow-md shadow-blue-200"
      >
        Cerrar
      </button>
    </div>
...
export function RateClientModal({
  ...
  return (
    ...
    >
      ...
      >
        {/* Header — Blue gradient to differentiate from client rating modal */}
        <div className="relative bg-gradient-to-r from-[#3B82F6] to-[#60A5FA] p-6 text-white">
          <button
            onClick={handleClose}
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-lg font-extrabold">Califica al Cliente</h2>
              <p className="text-sm text-white/80">Entrega completada con éxito</p>
            </div>
          </div>
        </div>
        ...
        <div className="p-6">
          {submitted ? (
            ...
            <div className="space-y-5">
              {/* Client info */}
              <div className="flex items-center gap-3 p-3.5 bg-blue-50 rounded-[12px] border border-blue-100">
                <div
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={3}
                  maxLength={500}
                  className="w-full px-3 py-2.5 border border-gray-200 rounded-[10px] text-sm resize-none focus:outline-none focus:border-[#3B82F6] transition-colors placeholder:text-gray-300"
                />
              ...
              <div className="flex gap-3">
                ...
                <button
                  ...
                  className="flex-1 flex items-center justify-center gap-2 py-2.5 bg-[#3B82F6] text-white rounded-[10px] text-sm font-bold hover:bg-[#2563EB] transition-all shadow-md shadow-blue-200 disabled:opacity-60"
                >
                  {isSubmitting ? (
